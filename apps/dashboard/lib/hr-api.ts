...
/**
 * Identity propagation (RBAC): forwards the session user's id/email/role/company
 * to Django via X-User-* headers. Reads directly from the hr_session cookie
 * (set at login) — no Supabase lookup needed.
 */
